                                    ...
                                    {lines.map(line => (
                                        <li key={line.line_id} className="p-4 flex justify-between items-center hover:bg-white transition-colors group bg-white">
                                                ...
                                                <div className="flex items-center gap-2 mt-1.5">
                                                    <div className="flex items-center bg-slate-100 rounded-lg overflow-hidden border border-slate-200">
                                                        <button 
                                                            ...
                                                            className="px-2 py-1 text-slate-600 hover:bg-slate-200 active:bg-slate-300 transition-colors"
                                                        >
                                                            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M20 12H4" /></svg>
                                                        </button>
                                                        <span className="px-3 py-1 bg-white text-xs font-black text-slate-800 border-x border-slate-200 min-w-[32px] text-center">
                                                            {line.quantity}
                                                        </span>
                                                        <button 
                                                            onClick={() => updateLineQty(line.line_id, 1)}
                                            ...
                                            <div className="flex items-center gap-4 shrink-0">
                                                ...
                                                <button onClick={() => removeLine(line.line_id)} className="w-8 h-8 rounded-full bg-slate-50 text-slate-300 hover:bg-rose-100 hover:text-rose-500 flex items-center justify-center transition-colors">
